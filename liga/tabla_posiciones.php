...
function obtenerInfoTorneoDivision(PDO $pdo, int $id_torneo, int $id_division): array
{
    ...
    try {
        ...
        // Obtener estadísticas de partidos de la PRIMERA FASE
...
function generarTablaPosiciones(PDO $pdo, int $id_torneo, int $id_division): array
{
    $tabla = [];

    // Obtener los clubes participantes en esta división y torneo
    // Esta consulta no necesita cambiar, ya que la membresía del club no depende de la fase
    ...
    // Obtener SOLO los partidos jugados de la 'Primera Fase' para este torneo y división
