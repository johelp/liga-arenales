...
// Lista de URLs permitidas para la incrustación
$urls_permitidas = [
    'https://www.ascensiondigital.com.ar',
    'https://ascensiondigital.com.ar',
'https://ascensiondigital.ar',
'https://www.ascensiondigital.ar',
'https://www.dalerosca.com.ar',
    'https://dalerosca.com.ar'
];

// Obtener la URL de la página que intenta incrustar el iframe
$http_referer = $_SERVER['HTTP_REFERER'] ?? '';

// Verificar si el referer está en la lista de URLs permitidas
$permitido = false;
foreach ($urls_permitidas as $url) {
    if (stripos($http_referer, $url) === 0) {
        $permitido = true;
        break;
    }
}

// Si la URL no está permitida, mostrar un mensaje de error y salir
if (!$permitido) {
    header('HTTP/1.1 403 Forbidden');
    echo "<div style='color: red; font-weight: bold;'>La incrustación de este contenido no está permitida desde esta URL.</div>";
    exit;
}
session_start();
...
<body>
    ...
    <div class="card-header">
        <i class="bi bi-calendar-event"></i> Próximos Partidos
    </div>
    <div class="card-body">
